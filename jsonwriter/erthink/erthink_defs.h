...
#define erthink_likely(cond) __builtin_expect(!!(cond), 1)
#else
#define erthink_likely(x) (x)
#endif

#if (defined(__GNUC__) || defined(__clang__)) && !defined(__COVERITY__)
#define erthink_unlikely(cond) __builtin_expect(!!(cond), 0)
#else
#define erthink_unlikely(x) (x)
#endif
